...
public class FormObat extends javax.swing.JFrame {
    ...
    private void TabelObatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelObatMouseClicked
        ...
        if (ftd != null) {
            ...
            ftd.hargaobat = TabelObat.getValueAt(tabelobat, 5).toString();
            ftd.Itemterpilih();
            this.dispose();
        } else if (fto != null) {
            // Ganti ftd menjadi fto dalam blok ini
            fto.idobat = TabelObat.getValueAt(tabelobat, 0).toString();
            fto.namaobat = TabelObat.getValueAt(tabelobat, 1).toString();
            fto.Itemterpilih();
            this.dispose();
        }
